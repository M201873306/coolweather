...
public class AutoUpdateService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        int tenHour = 10 * 60 *60 * 1000; //10 Hour
        long triggerAtTime = SystemClock.elapsedRealtime() + tenHour;
    ...
    private void updateWeather(){
        ...
        if(weather != null){
            ...
            String weatherId = weather1.basic.wetherId;
